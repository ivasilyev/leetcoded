...
that the element beyond the new length of the array can be anything.
...
0 2 3 4 5 3 1 0
    ^         ^
Move the element to be removed to the end of the array.
This is achieved b swapping thee element with the last element of the array.
